            ...
            <div className='p-28'>
                ...
                <div className="mx-auto w-72 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="flex flex-col items-center pb-10">
                        <Image className="w-24 h-24 mb-3 rounded-full shadow-lg" src={"https://nestjsproject-production-364f.up.railway.app/" + props.filename} alt="me" width="150" height="150" />
