            ...
            <div className='p-28'>
                    ...
                    <div className="mx-auto w-72 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="flex flex-col items-center pb-10">
                            <Image className="w-24 h-24 mb-3 rounded-full shadow-lg" src={"https://nestjsproject-production-364f.up.railway.app/admin/getimage/" + props.data.filename} alt="me" width="150" height="150" />


                            <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">{props.data.name}</h5>
                            <span className="text-sm text-gray-500 dark:text-gray-400">{props.data.email}</span>
                            <span className="text-sm text-gray-500 dark:text-gray-400">{props.data.address}</span>
